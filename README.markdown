...
============
    ...
    Even instances of SimpleXMLElement can be put to the cache. You dont have to matter about the size of the file. It 
    depends of the free space of your disk-space.
